...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="w-full bg-gradient-to-tr from-blue-300 to-blue-500 h-128">
            <div class="flex flex-col md:flex-row mx-auto gap-24 lg:max-w-7xl">
                <div class="relative mx-8 md:mx-0">
                    ...
                    <span class="inline-block -ml-44 relative top-12 text-4xl font-thin">My name's Len.</span>
                    <span class="inline-block ml-1 text-2xl relative top-12 text-blue-100 opacity-75 font-extralight">(He/Him/His)</span>
        ...
        <div class="w-full my-32">
            <div class="xl:flex w-4/5 mx-auto text-lg leading-relaxed text-gray-900 md:leading-loose md:text-xl font-extralight">
