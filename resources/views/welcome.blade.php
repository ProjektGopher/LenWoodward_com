...
<div class="relative overflow-hidden bg-white">
  ...
  <div class="relative w-full py-24 my-32 bg-gradient-to-br from-green-50 to-green-100">
      ...
      <p>That's cool and everything, but what are you actually good at?</p>
      ...
      <svg class="h-32" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
    ...
    <svg class="object-contain w-32 h-32" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 54 33">
    ...
    <svg class="object-contain w-32 h-32" viewBox="0 0 45.116 22.806" xmlns="http://www.w3.org/2000/svg">
        <g opacity=".8">
    ...
    <svg class="object-contain w-32 h-32" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 52">
        <title>Laravel Logomark</title>
    ...
    <svg class="h-32" viewBox="0 0 54 54" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <defs>
        ...
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="10.5″-iPad-Pro-Copy-6" transform="translate(-116.000000, -134.000000)">
                <g id="Group-3" transform="translate(115.000000, 136.000000)">
                    ...
                    <g id="Jelly" style="transform: translateY(-2.40437%);">
  ...
  <ul>
    ...
    github
     - this repo
      - version control
      - CI & CD
      - Vapor - serveless deployment
      - Domain and DNS
      - Testing
      - Asset purge & compilation
      - SVG creation, optimization, and inclusion
      - Design
      - Tailwind
      - Alpine
      - Livewire
